...
$message .= "http://uvidm.thecompletewebhosting.com/resetpassword.php?user_id=$user_id&key=$key";
if(mail($email, 'Reset your password', $message, 'From:'.'uvindukavinda@gmail.com')){
